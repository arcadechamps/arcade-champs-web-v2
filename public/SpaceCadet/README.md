# 3D Pinball Space Cadet on Arcade Champs

3D Pinball Space Cadet in JavaScript and WebAssembly running on Arcade Champs.
...
- The game is running on Arcade Champs in our custom iframe.
